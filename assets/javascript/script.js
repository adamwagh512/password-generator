...
//made a big ol' function to control password generation 
function generatePassword(){

    //made an empty string var for my function below to store data in 
    var length = ""
...
// The following are the arrays for uppercase, lower case, numbers and special characters// 
    ...
    //debugging console.log to ensure that the criteria selector works as it should
...
function randomSelector() {
    ...
    // create empty string to hold output of function
    let concatRandom = ''

    //These are instructions to pull the specified number of random characters from the array.
    for (let i=0; i < length; i++) { 
         let concatRandomIndex = Math.floor(Math.random() * concatLenghth)

        //links the numbers generated by concatRandomIndex to the actual concatRepo, which gives us our password and saves it to concatRandom
        //(shorthand version of concatRandom = concatRandom + concatRepo[concatRandomIndex])
         concatRandom += concatRepo[concatRandomIndex] 
    }
    //return for the randomSelector function
    return concatRandom
    }
    // Return for the generatePassword function
